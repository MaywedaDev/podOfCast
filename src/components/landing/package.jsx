const Package = ({name, price, perks, colored, position}) => {
    return ( <div className={` package ${position && "z-20"} relative`}>
        ...
        <div className={`px-10 py-8 rounded-xl section-2 border-[1.5px] ${colored ? "border-text-primary bg-[#F7EDE8]" : "border-black bg-white" } h-[312px] -z-10 top-0 left-0 w-full absolute`}>
