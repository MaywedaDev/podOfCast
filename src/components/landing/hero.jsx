...
const Hero = () => {
    return ( <div className="w-full bg-primary px-28 relative pb-28">
        ...
        <div className="max-w-[550px] mx-auto flex flex-col">
            ...
            <button className="mx-auto py-4 px-12 shadow-[4px_4px_0px_0px_rgba(0,0,0,0.25)] font-bold uppercase border-2 border-black text-white bg-black rounded-lg">Subscribe</button>
        </div>
